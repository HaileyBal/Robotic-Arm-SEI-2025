...
void loop()
{
    ...
    float threshold = 0.6;
    bool goDetected = false;
    bool stopDetected = true;
...
//EVERYTHING BELOW THIS POINT NEEDS TO EITHER BE PRESERVED OR COPIED
